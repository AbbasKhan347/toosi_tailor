...
const GALLERY = [
  ...
  { src: IMG2,   label_en: "Kids & Gents Kameez",       label_ur: "بچوں اور مردوں کی قمیض",  tall: false },
  { src: IMG3,   label_en: "Premium Shalwar Kameez",    label_ur: "پریمیم شلوار قمیض",        tall: false },
  { src: IMG4,   label_en: "Ladies & Gents Collection", label_ur: "خواتین اور مردوں کا کلیکشن", tall: true },
  { src: LADIES, label_en: "Ladies Suit Collection",    label_ur: "خواتین کا سوٹ کلیکشن",    tall: false },
];

const LAT = 24.8607, LNG = 67.0011;
...
const T = {
  en: {
    ...
    badge:"Premium Ladies & Gents Tailoring · Karachi, Pakistan",
    ...
    aboutP2:"Serving over 1,000 satisfied customers across Pakistan, our atelier specialises in bespoke suits, shalwar kameez, and ladies suits — each piece crafted to your exact measurements.",
    skills:[["Suit & Formal Wear",98],["Shalwar Kameez",96],["Alterations & Repairs",99]],
    ...
    srvSub:"From casual shalwar kameez to premium suits — stitched with care and expertise.",
    enquire:"Enquire Now →",
    portLabel:"Our Work", portT1:"Portfolio ", portT2:"Gallery",
    portSub:"A glimpse of our craftsmanship — real garments, real customers.",
    revLabel:"Customer Love", revT1:"What Customers ", revT2:"Say",
    ctaLabel:"Get In Touch", ctaT1:"Book Your ", ctaT2:"Appointment",
    phoneL:"Phone / WhatsApp", emailL:"Email", locL:"Location", locV:"Karachi, Pakistan",
    ...
    ftTag:"Premium Ladies & Gents Tailoring · Karachi, Pakistan",
    ftRights:"All rights reserved · Made with ❤️ in Pakistan",
    devCredit:"Designed & Developed by Hasnain Khan",
    devEmail:"555hasnainkhan@gmail.com",
    services:[
      ...
      {icon:"👗",title:"Ladies Suits",     desc:"Elegant ladies suits and traditional wear stitched with premium quality and perfect fit."},
      {icon:"🪡",title:"Alterations",      desc:"Expert resizing, hemming, and repairs to breathe new life into any garment."},
      {icon:"🧥",title:"Waistcoats",       desc:"Fitted waistcoats in your choice of fabric, perfect to pair with any formal outfit."},
    ],
    reviews:[
      {name:"Ahmed K.", stars:5, text:"Toosi Tailor stitched my formal suit perfectly. The fit was immaculate. Highly recommended!"},
  ...
  ur: {
    ...
    urduBtn:"اردو", engBtn:"English",
    badge:"پریمیم خواتین اور مردوں کی سلائی · کراچی، پاکستان",
    ...
    aboutP2:"پاکستان میں 1,000 سے زیادہ مطمئن گاہکوں کی خدمت کرتے ہوئے ہمارا ادارہ خصوصی سوٹ، شلوار قمیض اور خواتین کے لباس میں مہارت رکھتا ہے۔",
    skills:[["سوٹ اور رسمی لباس",98],["شلوار قمیض",96],["ترمیم اور مرمت",99]],
    ...
    srvSub:"سادہ شلوار قمیض سے پریمیم سوٹ تک — محبت اور لگن سے تیار کردہ۔",
    enquire:"← ابھی پوچھیں",
    portLabel:"ہمارا کام", portT1:"پورٹ فولیو ", portT2:"گیلری",
    portSub:"ہماری کاریگری کی ایک جھلک — اصل لباس، اصل گاہک۔",
    formT:"پیغام بھیجیں",
    revLabel:"گاہکوں کی محبت", revT1:"گاہک کیا ", revT2:"کہتے ہیں",
    ctaLabel:"رابطہ کریں", ctaT1:"اپنی اپوائنٹمنٹ ", ctaT2:"بک کریں",
    phoneL:"فون / واٹس ایپ", emailL:"ای میل", locL:"مقام", locV:"کراچی، پاکستان",
    hrsL:"کام کے اوقات", hrsV:"پیر تا ہفتہ · صبح 9 بجے تا شام 8 بجے · جمعہ کو چھوڑ کر",
    wa:"💬 واٹس ایپ پر بات کریں", waMsg:"میں سوٹ سلوانا چاہتا ہوں۔\nکیا آپ اپنی دکان پر موجود ہیں؟",    nameP:"آپ کا نام", phoneP:"فون نمبر", selSrv:"خدمت منتخب کریں",
    ...
    ftTag:"پریمیم خواتین اور مردوں کی سلائی · کراچی، پاکستان",
    ftRights:"تمام حقوق محفوظ ہیں · پاکستان میں محبت سے بنایا گیا",
    devCredit:"ڈیزائن اور ڈویلپمنٹ: حسنین خان",
    devEmail:"555hasnainkhan@gmail.com",
    services:[
      ...
      {icon:"👗",title:"خواتین کے سوٹ", desc:"اعلیٰ معیار کے خواتین کے سوٹ اور روایتی لباس — بالکل فٹ اور خوبصورت۔"},
      {icon:"🪡",title:"ترمیم",          desc:"کسی بھی لباس کو نئی زندگی دینے کے لیے ماہرانہ ترمیم اور مرمت۔"},
      {icon:"🧥",title:"واسکٹ",          desc:"آپ کی پسند کے کپڑے میں فٹ واسکٹ، کسی بھی رسمی لباس کے ساتھ بہترین۔"},
    ],
    reviews:[
      {name:"احمد ک.",  stars:5, text:"ٹوسی ٹیلر نے میرا رسمی سوٹ بالکل درست بنایا۔ فٹ بے مثال تھا۔ سب کو سفارش کرتا ہوں!"},
  ...
  return (
    <div dir={dir} style={{background:"var(--bg)", minHeight:"100vh", fontFamily:urf}}>
      ...
      <section id="about" style={{padding:"6rem 1.5rem",maxWidth:"1200px",margin:"0 auto"}}>
        <div className="about-wrap reveal" style={{display:"flex",flexWrap:"wrap",gap:"4rem",alignItems:"center",justifyContent:"center"}}>
          ...
          <div style={{position:"relative"}}>
            <div className="photo-frame" style={{border:"3px solid var(--gold)",background:"#000"}}>
              <img src={MY_PROFILE} alt="Master Tailor" style={{width:"100%",height:"100%",objectFit:"cover",objectPosition:"top"}} />
            </div>
            <div style={{position:"absolute",bottom:"-16px",right:isUr?"auto":"-16px",left:isUr?"-16px":"auto",width:"105px",height:"130px",borderRadius:"12px",overflow:"hidden",border:"2px solid var(--sky)",boxShadow:"0 8px 24px rgba(37,99,235,.4)"}}>
              <img src={DAD_PROFILE} alt="Senior Tailor" style={{width:"100%",height:"100%",objectFit:"cover",objectPosition:"top"}} />
            </div>
            <div style={{position:"absolute",bottom:"-20px",left:isUr?"auto":"50%",right:isUr?"50%":"auto",transform:"translateX(-50%)",background:"linear-gradient(135deg,var(--royal),var(--blue))",borderRadius:"14px",padding:".7rem 1rem",border:"1px solid rgba(96,165,250,.3)",boxShadow:"0 12px 36px rgba(37,99,235,.35)",textAlign:"center",animation:"floatY 3.5s ease-in-out infinite",zIndex:10}}>
              <div style={{fontFamily:"'Playfair Display',serif",fontSize:"1.6rem",fontWeight:700,color:"var(--gold)"}}>15+</div>
              <div style={{fontSize:".58rem",color:"var(--ice)",textTransform:"uppercase",letterSpacing:".1em",fontFamily:urf}}>{t.yrs}</div>
            </div>
          </div>
      ...
      <section id="portfolio" style={{padding:"6rem 1.5rem",maxWidth:"1200px",margin:"0 auto"}}>
        ...
        <div className="gal-grid" style={{display:"grid",gridTemplateColumns:"repeat(auto-fit,minmax(220px,1fr))",gap:"1rem"}}>
          {GALLERY.map(({src, label_en, label_ur, tall}, i) => (
            <div key={i} className="gal-item reveal" style={{height:tall?"300px":"220px",background:"#000"}}>
              <img src={src} alt={label_en} style={{width:"100%",height:"100%",objectFit:"cover",transition:"transform .6s ease"}} />
              <div className="gal-ov">
                <span style={{color:"var(--ice)",fontSize:".85rem",fontWeight:600,fontFamily:urf}}>
                  {isUr ? label_ur : label_en}
                </span>
              </div>
            </div>
          ))}
...
>
  <span style={{fontFamily:urf}}>{t.wa}</span>
      ...
      <footer className="footer">
        ...
        <div style={{marginTop:"1.4rem",padding:".9rem 1.6rem",background:"rgba(37,99,235,.08)",border:"1px solid rgba(96,165,250,.18)",borderRadius:"10px",display:"inline-block"}}>
          <p style={{color:"var(--muted)",fontSize:".72rem",marginBottom:".25rem"}}>
            💻 {T.en.devCredit} · <a href={`mailto:${T.en.devEmail}`} style={{color:"var(--sky)",textDecoration:"none"}}>{T.en.devEmail}</a>
          </p>
          <p style={{color:"var(--dim)",fontSize:".68rem",fontFamily:"'Noto Nastaliq Urdu',serif",direction:"rtl"}}>
            {T.ur.devCredit} · <a href={`mailto:${T.ur.devEmail}`} style={{color:"var(--sky)",textDecoration:"none"}}>{T.ur.devEmail}</a>
          </p>
        </div>
      </footer>
